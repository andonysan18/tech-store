        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><Link href="/category/audio" className="hover:text-blue-600 transition-colors">Audio</Link></li>
          ...
          {/* Columna 3: Servicios */}
          <div className="space-y-4">
            <h4 className="text-sm font-bold uppercase tracking-wider text-slate-900">Servicios</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link href="/repair" className="hover:text-blue-600 transition-colors">Servicio Técnico</Link></li>
              <li><Link href="/rapir/tracking" className="hover:text-blue-600 transition-colors">Seguimiento de Equipo</Link></li>
              <li><Link href="/search" className="hover:text-blue-600 transition-colors">Buscar Producto</Link></li>
            </ul>
          </div>
