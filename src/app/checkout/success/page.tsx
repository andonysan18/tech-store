...
import { useEffect, Suspense } from "react"; // 1. Agregamos Suspense
...
// 2. Este es el componente interno con la lógica (NO se exporta por defecto)
...
// 3. Este es el componente PRINCIPAL que se exporta y contiene el SUSPENSE
export default function SuccessPage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 px-4 py-12 text-center">
      <Suspense fallback={<div className="animate-pulse text-slate-400">Cargando detalles del pedido...</div>}>
        <SuccessContent />
      </Suspense>
    </div>
  );
